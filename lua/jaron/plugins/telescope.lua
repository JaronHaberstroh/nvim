return {
	...
	keys = {
		...
		{ "<leader>fc", require("telescope.builtin").grep_string, desc = "Telescope find string under cursor" },
		{ "<leader>fb", require("telescope.builtin").builtin, desc = "Telescope buffers" },
